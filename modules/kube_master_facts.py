...
DOCUMENTATION = r'''
---
module: kube_master_facts
short_description: Search the facts return for specific Kubernetes masters  for vSphere virtual machine guest
description:
...
def get_kube_master_virtual_machines(content):
    ...
    for vm in virtual_machines:
        ...
        if bool(re.search('master', vm.summary.config.name)):
            summary = vm.summary
...
def main():
    ...
    try:
        ...
        _virtual_machines = get_kube_master_virtual_machines(content)
